...
@if(Route::currentRouteName() == 'frontend.post' or Route::currentRouteName() == 'frontend.allPosts')
                        ...
                        <div class="heading heading-border heading-middle-border">
                            <h3 class="text-4">
                                <strong class="font-weight-bold text-1 px-3 text-light py-2 bg-primary">
                                    @if(Route::currentRouteName() == 'frontend.allPosts')
                                        @lang('backend.news')
                                    @else
                                    ...
                                    <article class="post post-medium border-0 pb-0 mb-5">
                                        <div class="post-image"
                                            ...
                                            <a href="{{ route('frontend.selectedPost',$post->id) }}">
                                                <img src="{{ asset($post->photo) }}" class="img-resize"
                                                     alt="{{ $post->translate(app()->getLocale())->title }}">
                                            </a>
                                        </div>
                                        <div class="post-content">
                                            <h1 class="font-weight-semibold text-5 line-height-6 mt-3 mb-2 titles">
                                                <a href="{{ route('frontend.selectedPost',$post->id) }}"
                                        ...
                                        <span>
                                            ...
                                            <a href="{{route('frontend.selectedPost',$post->id)}}"
                                               class="text-lowercase read-more text-color-dark font-weight-bold text-2">@lang('backend.read-more')<i

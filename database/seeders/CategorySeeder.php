        ...
        $categories = [
            ...
            'education' => [
                ...
                'categories' =>
                    [
                        'master' => [
                            'translations' => ['az' => 'Magistr', 'en' => 'Master degree', 'ru' => 'Степень магистра'],
                            'alt-categories' => [
                                'legal-normative-documents' => ['az' => 'Hüquqi normativ sənədlər', 'en' => 'Legal normative documents', 'ru' => 'Нормативно-правовые документы'],
                                'specialization-keys' => ['az' => 'İxtisas şifrələri', 'en' => 'Specialty passwords', 'ru' => 'Специальные пароли'],
                                'about-mba' => ['az' => 'MBA haqqında', 'en' => 'About MBA', 'ru' => 'О МВА'],
                                'gead-master-handbook' => ['az' => 'GEAD Magistr kitabçası', 'en' => 'GEAD Master Handbook', 'ru' => 'Справочник мастера GEAD'],
                            ]
                        ],
                        'doctorate' => [
                            'translations' => ['az' => 'Doktorantura', 'en' => 'Doctorate', 'ru' => 'Докторантура'],
                            'alt-categories' => [
                                'legal-normative-documents' => ['az' => 'Hüquqi normativ sənədlər', 'en' => 'Legal normative documents', 'ru' => 'Правовые нормативные документы'],
                                'specialization-keys' => ['az' => 'İxtisas şifrələri', 'en' => 'Specialty passwords', 'ru' => 'Специальные пароли'],
                            ]
                        ],
                        'residency' => [
            ...
            'education-abroad' => [
                ...
                'categories' =>
                    [
                        'master' => ['translations' => ['az' => 'Magistr', 'en' => 'Master degree', 'ru' => 'Степень магистра']],
            ...
            'scientific-activity' => [
                ...
                'categories' =>
                    [
                        ...
                        'dissertation-drafting-rules' => ['translations' => ['az' => 'Dissertasiyanın tərtibi qaydaları', 'en' => 'Dissertation drafting rules', 'ru' => 'Правила оформления диссертации']],
